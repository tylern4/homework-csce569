...
void jacobi_seq(long n, long m, REAL dx, REAL dy, REAL alpha, REAL relax, REAL *u_p, REAL *f_p, REAL tol,
                int mits);
void jacobi_omp(long n, long m, REAL dx, REAL dy, REAL alpha, REAL relax, REAL *u_p, REAL *f_p, REAL tol,
                int mits);
int num_threads = 4;
...
#pragma omp master
  ...
  printf(
      "================================= Parallel OpenMP Execution (%d threads) "
      "======================================\n",
      num_threads);
  ...
  printf("omp(%d threads):\t%.2f\t\t%.2f\t\t%g\n", num_threads, elapsed_omp, flops / (1.0e3 * elapsed_omp),
...
void jacobi_omp(long n, long m, REAL dx, REAL dy, REAL alpha, REAL omega, REAL *u_p, REAL *f_p, REAL tol,
                int mits) {
  long i, j, k;
  REAL error;
  REAL ax;
